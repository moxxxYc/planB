...
5. **Skips audio assets entirely.** Codex gravitates toward visual and mesh assets because they have more obvious metrics. Audio assets have their own format, bitrate, sample rate, and loudness requirements. Check them explicitly — they are assets too.
