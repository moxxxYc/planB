...
**After completing Phase 1, present findings by asking the user directly.** Include the emotion at each checkpoint moment. Example:
...
**After completing Phase 2, present findings by asking the user directly** — same format as Phase 1 transition.
...
**After completing Phase 3, present findings by asking the user directly** — same format. This is the most important transition because it's where the first session ends. Ask specifically:
