...
**Critical check:** Sum all subsystem budgets. If total exceeds "Available for Game" for the target platform's minimum spec, the architecture is over-committed. This is the "multiplication" Codex tends to skip.
