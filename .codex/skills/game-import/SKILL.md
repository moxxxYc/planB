...
Read the file. Then summarize what you found by asking the user directly:
...
Ask these questions **ONE AT A TIME** by asking the user directly. Each question builds on the previous answer.
...
Map all collected content against the **8-section GDD standard**. Present the audit by asking the user directly:
...
**Ask these ONE AT A TIME by asking the user directly.**
...
Present the final result by asking the user directly:
