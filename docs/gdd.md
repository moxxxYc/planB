...
**最后更新：** 2026-06-08
**仓库状态：** 文档主导，当前活动 MVP v0 实现目录为 `godot/`；GDD 是设计总纲，不作为代码状态证明。
...
- `docs/ball-machine-physical.md`：MVP v0 实现输入。可指导当前 `godot/` 的物理表现假设；具体参数和各效果物理表现仍未 playtest，未最终锁定为长期 canon。
