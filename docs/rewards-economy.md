...
**文档状态：** MVP v0 奖励经济输入。候选池结构、软分池、奖励 / 商店投放规则、Gold faucet、价格带、职责带平衡口径和休整结果页口径已确认；第二次奖励固定为 Battle 4 后的免费奖励，不开第二次商店。精确 playtest 后最终平衡和种族包装未确认，不能直接视为长期正式平衡。

本文记录 MVP v0 的奖励、商店、Gold、休整和第一批中立修正候选。第一次奖励三轴锚点、第一次商店候选池、`Echo Latch` 位置、第二次奖励生成规则、Gold faucet、价格带、职责带平衡口径和休整结果页口径已确认；这些内容可作为 MVP v0 候选池和经济节奏口径，其余未确认内容不定义逐场战斗脚本、具体种族单位或 Guardian 技能。
...
第一版不要一次把 9 个都塞进玩家脸上。候选池结构和投放规则已确认，可作为 MVP v0 候选池输入；精确数值、最终平衡和战斗脚本未确认前，不能作为长期正式平衡输入。
